...
export const MY_ORGANIZATION_MEMBERS_MANAGER_SCOPES =
  'read:my_org:members delete:my_org:members read:my_org:member_invitations create:my_org:member_invitations delete:my_org:member_invitations read:my_org:roles update:my_org:member_roles';

...
export const MY_ORGANIZATION_INVITATIONS_TABLE_SCOPES =
  'read:my_org:member_invitations create:my_org:member_invitations delete:my_org:member_invitations read:my_org:roles';

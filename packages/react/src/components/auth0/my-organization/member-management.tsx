...
/**
 * Organization member management dashboard.
 *
 * A comprehensive component for managing organization settings including
 * details, SSO providers, and domain management. Provides a tabbed interface
 * for navigation between different management sections.
 *
